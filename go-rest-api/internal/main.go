...
import (
    ...
    "github.com/11Hawks/learning-go-by-example/go-rest-api/pkg/swagger/server/restapi"

    "github.com/11Hawks/learning-go-by-example/go-rest-api/pkg/swagger/server/restapi/operations"
)
func main() {
	//Initialize Swagger
